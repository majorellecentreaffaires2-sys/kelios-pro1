  ...
  return (
    <aside className="w-20 md:w-72 h-screen glass sticky top-0 flex flex-col border-r border-blue-100/50 z-50">
      <div className="p-6 overflow-y-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div className="hidden md:block">
            <h1 className="font-black text-lg text-gray-900 leading-none">
              GFD
            </h1>
            <span className="text-[10px] font-bold text-blue-500 uppercase tracking-widest text-nowrap">
              logiciel-gfd
            </span>
          </div>
        </div>
        ...
        <div className="relative mb-8">
          <button
            ...
            className="w-full bg-white border border-blue-50 p-3 rounded-2xl flex items-center justify-between hover:border-blue-300 transition-all shadow-sm"
          >
            <div className="flex items-center gap-3 overflow-hidden">
              ...
              <span className="hidden md:block font-black text-xs truncate uppercase tracking-tighter">
              ...
              {companies.map((c) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-bold text-xs uppercase truncate tracking-tighter">
                      {c.name}
                    </p>
                    {!c.active && (
                      <p className="text-[7px] font-black text-red-400 uppercase tracking-widest">
                        Désactivée
                      </p>
                    )}
                  </div>
      ...
      <div className="mt-auto p-6 space-y-4">
        <button
          onClick={onExit}
          className="w-full flex items-center gap-4 px-4 py-3.5 rounded-2xl text-red-400 hover:bg-red-50 hover:text-red-600 transition-all font-black text-xs uppercase tracking-widest"
        >
