...
export const api = {
  ...
  // Notifications
  getNotifications: () => request<any[]>(`${API_BASE}/notifications`),
  markNotificationRead: (id: string) => request<{ success: boolean }>(`${API_BASE}/notifications/${id}/read`, 'PUT'),
  markAllNotificationsRead: () => request<{ success: boolean }>(`${API_BASE}/notifications/read-all`, 'PUT'),
